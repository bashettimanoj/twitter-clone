...
// all the people who logged the user if following 
...
// get all likes of a tweet with tweet_id if the user follows the twitter
app.get("/tweets/:tweetId/likes/",
authenticateToken, follows, async (request, response) => {
    const { tweetId } = request.params;
...
//get all replies of a tweet with tweet_id if the user follows the twitter
app.get("/tweets/:tweetId/ replies/", authenticateToken, follows,
async (request, response) => {
    const { tweetId } = request.params;
